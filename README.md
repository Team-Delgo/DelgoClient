...
### 전국민 반려인을 위한 반려견 동반 인증 SNS 서비스 플랫폼

- **장소 인증**
    - 카테고리 별 업적 부여, 인증 횟수 카운트
    - 인증시 사진첩, 캘린더, 커뮤니티 노출
    - 델고 선정 멍플 장소 인증시 포인트 획득, 지도 마크
- **멍플 지도**
    - 델고 선정 멍플 장소 위치 마커 표시
    - 델고 선정 멍플 장소 인증 시 기록 마커 표시
- **업적 서비스**
    - 카테고리 별 특정 인증 횟수 초과시 업적 부여
    - 대표 업적과 모든 업적을 설정, 관리
- **랭킹 서비스**
    - 사용자 주거지 주소기반 주 단위 포인트 랭킹 순위
